        ...
        while (option != 7) {
            switch (option) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    servPers.esMayorDeEdad(p1);
                    servPers.esMayorDeEdad(p2);
                    servPers.esMayorDeEdad(p3);
                    servPers.esMayorDeEdad(p4);
                    servPers.mostrarMenu();
                    option = read.nextInt();
                    break;
                case 4:
                    int cont = 0;
                    int porc;
                    boolean resultEsM1 = servPers.esMayorDeEdad(p1);
                    boolean resultEsM2 = servPers.esMayorDeEdad(p2);
                    boolean resultEsM3 = servPers.esMayorDeEdad(p3);
                    boolean resultEsM4 = servPers.esMayorDeEdad(p4);
                    if (resultEsM1 == true) {
                        cont++;
                    }
                    if (resultEsM2 == true) {
